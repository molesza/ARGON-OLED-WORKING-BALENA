...
if os.path.exists("argoneonoled.py"):
	import datetime
	from argoneonoled import *
	OLED_ENABLED=True

OLED_CONFIGFILE = "argoneonoled.conf"
UNIT_CONFIGFILE = "argonunits.conf"
...
def load_fancpuconfig():
	...
	tmpconfig = load_config("argononed.conf")
	if len(tmpconfig) > 0:
		fanconfig = tmpconfig
	return fanconfig
...
def load_fanhddconfig():
	...
	fanhddconfigfile = "argononed-hdd.conf"
